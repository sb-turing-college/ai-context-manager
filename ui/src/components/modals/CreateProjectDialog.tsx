...
export function CreateProjectDialog({ isOpen, onClose, onConfirm }: CreateProjectDialogProps) {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-xl font-bold text-slate-100 mb-4">New project</h2>
